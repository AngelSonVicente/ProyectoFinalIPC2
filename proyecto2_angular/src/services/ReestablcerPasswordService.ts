...
export class ReestablcerPasswordService {
    ...
    public actualizarPassword(cuenta: CambiarPassword): Observable<CambiarPassword> {
        return this.httpClient.put<CambiarPassword>(this.API_URL + "ReestablecerPasword", cuenta);
    }
