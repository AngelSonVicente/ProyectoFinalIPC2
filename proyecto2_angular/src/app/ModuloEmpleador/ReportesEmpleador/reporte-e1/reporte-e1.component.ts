  ...
  constructor(private reportesService: ReportesService, private modalService: BsModalService) { }
    ...
    realizarAccion(datosFormulario: any): void {
      ...
      if (datosFormulario.fecha1 && datosFormulario.fecha2) {
        ...
        this.reportesService.getReporte1Empleador(this.usuario.codigo.toString(), datosFormulario.fecha1 , datosFormulario.fecha2 ).subscribe(data => {
          this.reporte1 = data;
        });
      } else {
        this.fecha11="nada";
        ...
        this.reportesService.getReporte1Empleador(this.usuario.codigo.toString(),this.fecha11 ,this.fecha22 ).subscribe(data => {
          this.reporte1 = data;
        });
